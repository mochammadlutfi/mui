...
<div class="content">
    <nav class="breadcrumb bg-white push">
        ...
        <span class="breadcrumb-item active">Majalah</span>
    </nav>
    <div class="row">
        <div class="col-lg-12">
            <!-- Default Elements -->
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Kelola Majalah</h3>
    ...
    <div class="modal-dialog modal-dialog-popout modal-lg" role="document">
        <div class="modal-content">
            <div class="block mb-0">
                <div class="block-header block-header-default">
                        <h3 class="block-title modal-title">Tambah Majalah Baru</h3>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <label class="col-form-label" for="field-judul">Judul Majalah</label>
                                        <input type="text" class="form-control" id="field-judul" name="judul" placeholder="Masukan Judul Majalah">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <textarea class="form-control" id="deskripsi" name="deskripsi" maxlength="115" data-always-show="true" data-placement="top" placeholder="Masukan Deskripsi" rows="2"></textarea>
                                ...
                                <div class="form-group row">
                                    <label class="col-12" for="seo_description">SEO deskripsi</label>
                                    <div class="col-12">
...
$('#field-judul').change(function(e) {
    $.get("{{ route('admin.majalah.check_slug') }}",
      { 'nama': $(this).val() },
      function( data ) {
...
jQuery(document).ready(function () {
    ...
    $(document).on('click', '#btn_tambah', function () {
        save_method = 'tambah';
        $('#form-album')[0].reset();
        $('#modal_title').text('Tambah Data Majalah');
        $('#modal_form').modal({
            backdrop: 'static',
            keyboard: false
        })
    ...
    $("#form-album").submit(function (e) {
        ...
        if (save_method == 'tambah') {
            link = "{{ route('admin.majalah.simpan') }}";
            pesan = "Album Baru Berhasil Ditambahkan";
        } else {
            link = "{{ route('admin.majalah.update') }}";
...
function edit(id){
    ...
    $.ajax({
        url : laroute.route('admin.majalah.edit', {id : id}),
        type: "GET",
        dataType: "JSON",
        success: function(response)
        {
...
function hapus(id) {
    ...
    .then((willDelete) => {
        if (willDelete) {
        $.ajax({
            url: laroute.route('admin.majalah.hapus', { id: id }),
            type: "get",
            dataType: "JSON",
