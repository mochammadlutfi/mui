        ...
        <div class="col-lg-12">
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Kelola Infografis</h3>
    ...
    <div class="modal-dialog modal-dialog-popout modal-lg" role="document">
        <div class="modal-content">
            <div class="block mb-0">
                <div class="block-header block-header-default">
                        <h3 class="block-title modal-title">Tambah Infografis Baru</h3>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <label class="col-form-label" for="field-judul">Judul Infografis</label>
                                        <input type="text" class="form-control" id="field-judul" name="judul" placeholder="Masukan Judul Infografis">
...
$('#field-judul').change(function(e) {
    $.get("{{ route('admin.infografis.check_slug') }}",
      { 'nama': $(this).val() },
      function( data ) {
...
jQuery(document).ready(function () {
    ...
    $(document).on('click', '#btn_tambah', function () {
        save_method = 'tambah';
        $('#form-album')[0].reset();
        $('#modal_title').text('Tambah Data infografis');
        $('#modal_form').modal({
            backdrop: 'static',
            keyboard: false
        })
    ...
    $("#form-album").submit(function (e) {
        ...
        if (save_method == 'tambah') {
            link = "{{ route('admin.infografis.simpan') }}";
            pesan = "Album Baru Berhasil Ditambahkan";
        } else {
            link = "{{ route('admin.infografis.update') }}";
...
function edit(id){
    ...
    $.ajax({
        url : laroute.route('admin.infografis.edit', {id : id}),
        type: "GET",
        dataType: "JSON",
        success: function(response)
        {
...
function hapus(id) {
    ...
    .then((willDelete) => {
        if (willDelete) {
        $.ajax({
            url: laroute.route('admin.infografis.hapus', { id: id }),
            type: "get",
            dataType: "JSON",
