                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group row">
                                    ...
                                    <input value="{{ $berita->judul }}" type="text" class="form-control" id="field-judul" name="judul" placeholder="Masukan Judul Berita">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        ...
                                        <input value="{{ $berita->slug }}" type="text" class="form-control" id="field-slug" name="slug" placeholder="Slug Berita" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12">Deskripsi</label>
                                    <div class="col-12">
                                        <textarea class="form-control" id="field-deskripsi" name="deskripsi" placeholder="Masukan Deskripsi Event" rows="8">{{ $berita->deskripsi }}</textarea>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <select class="form-control" name="b_kategori_id" id="field-b_kategori_id">
                                            ...
                                            @foreach ($kategori as $k)
                                                <option {{ $k->id == $berita->b_kategori_id ? 'selected' : '' }} value="{{ $k->id }}">{{ $k->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <input type="text" value="{{ $berita->seo_keyword }}" class="form-control" id="seo_keyword" name="seo_keyword" placeholder="Masukan SEO Keyword">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <input type="text" value="{{ $berita->seo_tags }}" class="form-control" id="seo_tags" name="seo_tags" placeholder="Masukan SEO Tags">
                                        <div class="form-text text-muted font-size-sm text-right">Gunakan tanda koma "," sebagai pemisah!</div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <textarea class="form-control" id="seo_description" name="seo_description" maxlength="115" data-always-show="true" data-placement="top" placeholder="Masukan SEO Deskripsi" rows="2">{{ $berita->seo_description }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <label class="css-control css-control-primary css-radio">
                                            <input type="radio" class="css-control-input" id="status_publikasi" name="status" value="1" {{ $berita->status == 1 ? 'checked' : '' }}>
                                            <span class="css-control-indicator"></span> Publikasikan
                                        </label>
                                        <label class="css-control css-control-secondary css-radio">
                                            <input type="radio" class="css-control-input" id="status_draft" name="status" value="0" {{ $berita->status == 0 ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="row justify-content-center mb-10">
                                        <div class="col-12">
                                            ...
                                            @else
                                            <img id="img_preview" src="{{ asset('uploads/'.$berita->foto) }}" width="100%">
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <input type="text" class="form-control" id="field-foto_desk" name="foto_desk" placeholder="Masukan Deksripsi Foto" value="{{ $berita->foto_desk }}">
