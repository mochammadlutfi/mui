                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="page-title-heading">
                            <h1 class="title">{{ $infografis->judul }}</h1>
                        ...
                        <div class="project-gallery project-gallery-list">
                            <div class="project-gallery-wrap">
                                <div class="project-media-item">
                                    <a class="popup-gallery" href="images/projects/ps1.jpg"><img src="{{ asset('uploads/'. $infografis->foto)}}" alt="images"></a>
                                </div>
                            </div><!-- /.project-gallery-wrap -->
                            <div class="header-post">
                                        <p class="time-post">{{ $infografis->created_at->format('M, d Y') }}</p>
                                    </div><!-- /.header-post -->
